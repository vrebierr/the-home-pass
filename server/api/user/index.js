...
router.get('/me/likes', auth.isAuthenticated(), controller.getLikes)
router.post('/likes', auth.isAuthenticated(), controller.like);
router.delete('/likes/:id', auth.isAuthenticated(), controller.removeLike);
